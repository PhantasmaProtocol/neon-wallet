...
import { TOKENS, TOKENS_TEST, MAIN_NETWORK_ID, TEST_NETWORK_ID, PRIVATE_NETWORK_ID } from './constants'
...
export const getDefaultTokens = (): Array<TokenItemType> => {
  ...
  tokens.push(...map(TOKENS_TEST, (scriptHash, symbol) => getTokenEntry(symbol, scriptHash, PRIVATE_NETWORK_ID)))
